            ...
            <section className='h-96 scroll-smooth'>
                <div className='md:mt-[250px] mt-[80px]'>
                    <motion.h1 
                        ...
                        transition={{ delay: .75, duration:5, type: 'spring', stiffness: 100 }}
                    className='text-center text-slate-300 md:mt-[-50px]'>FIND <span className='text-[#c770f0]'>ME</span> ON</motion.h1>
                    <ul className='mt-[80px] flex justify-center items-center gap-12'>
                        ...
                        title='facebook' className='ml-[-5px]'>
                        ...
                        <motion.li 
                            ...
                            viewport={{ once: true, amount: .1 }}
                            transition={{ delay: .3, type: 'spring', stiffness: 100 }}
                        title='instagram'><a href="https://www.instagram.com/sbm7586?igsh=MTBvZ21wbDJnY3MyNA%3D%3D&utm_source=qr">
