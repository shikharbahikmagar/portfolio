    ...
    return (
        <nav
            ...
            <motion.div
                ...
                <Link to="/livestream"> <h2 className='md:hidden text-slate-300 text-xl relative after:bg-purple-400 after:absolute after:h-[2px] after:w-0 after:bottom-0 after:left-0 hover:after:w-full hover:text-purple-400 after:transition-all after:duration-[.7s] cursor-pointer'>Watch IPL</h2></Link>
